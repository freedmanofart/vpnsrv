...
Telegram-бот и web-кабинет читают пакеты из этой таблицы, поэтому изменение
названия, описания или лимитов пакета сразу влияет на экран выбора пакета в
боте и на страницы кабинета после обновления данных.
