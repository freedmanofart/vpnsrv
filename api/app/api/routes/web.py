...
main.cabinet>.eyebrow,main.cabinet>h2{{text-align:center}}main.cabinet>h2{{font-size:31.5px;overflow-wrap:anywhere;word-break:break-word;margin-bottom:26px}}@media(max-width:760px){{main.cabinet>h2{{font-size:28px}}}}@media(max-width:520px){{.f-actions .f-btn:not(.primary){{display:inline-flex}}}}
