...
.landing-page{{min-height:100dvh;display:grid;grid-template-rows:auto 1fr 36px}}.landing-page .f-hero{{min-height:calc(100dvh - 112px);border-radius:0;padding:clamp(32px,5vh,54px) 38px;gap:32px}}.landing-page .f-hero h1{{font-size:clamp(36px,4.4vw,58px);font-weight:620;margin-bottom:18px}}.landing-page .f-kicker{{margin-bottom:16px}}.landing-page .f-lead{{font-size:15px;line-height:1.55;margin-bottom:23px}}.landing-page .f-btn.primary{{padding:10px 18px}}.landing-page .f-trust{{margin-top:22px}}.landing-page .f-preview{{max-width:440px;justify-self:end;padding:11px;border-radius:23px}}.landing-page .f-preview-inner{{padding:20px}}.landing-page .f-preview-top{{margin-bottom:20px}}.landing-page .f-key{{padding:13px}}.landing-page .f-stat{{padding:12px}}.landing-page .f-cabinet{{color:#fff;border-color:var(--blue);background:var(--blue);padding-left:21px;padding-right:21px}}.landing-page .f-cabinet:hover{{border-color:#0d49ea;background:#0d49ea;box-shadow:0 8px 22px #175cff28}}.f-footer{{height:36px;padding:0;display:flex;align-items:center;justify-content:center;background:#fff;color:var(--muted);font-size:11px;border-top:1px solid #eef1f6}}@media(max-width:850px){{.landing-page .f-hero{{min-height:calc(100dvh - 112px);display:grid;grid-template-columns:1fr;align-content:center;padding:20px 24px;gap:18px}}.landing-page .f-visual{{display:block;width:min(440px,100%);margin:0 auto}}.landing-page .f-hero>div:first-child{{width:min(560px,100%);margin:0 auto;text-align:center}}.landing-page .f-kicker,.landing-page .f-hero-actions,.landing-page .f-trust{{justify-content:center}}.landing-page .f-lead{{margin-left:auto;margin-right:auto}}.landing-page .f-preview{{justify-self:center;width:100%}}}}@media(max-width:520px){{.landing-page{{grid-template-rows:auto 1fr 32px}}.landing-page .f-actions .f-cabinet{{display:inline-flex}}.landing-page .f-hero{{min-height:calc(100dvh - 96px);padding:12px 14px;gap:10px}}.landing-page .f-hero h1{{font-size:clamp(30px,9vw,38px);margin-bottom:10px}}.landing-page .f-kicker{{font-size:8px;margin-bottom:8px}}.landing-page .f-lead{{font-size:12.5px;line-height:1.38;margin-bottom:10px}}.landing-page .f-btn.primary{{padding:8px 14px}}.landing-page .f-trust{{gap:7px 12px;margin-top:10px;font-size:10px}}.landing-page .f-preview{{max-width:340px;padding:5px;border-radius:14px}}.landing-page .f-preview-inner{{padding:8px;border-radius:10px}}.landing-page .f-preview-top{{margin-bottom:6px}}.landing-page .f-preview-brand{{gap:5px;font-size:11px}}.landing-page .f-preview-brand .f-mark{{width:22px;height:22px}}.landing-page .f-status{{padding:4px 6px;font-size:8px;gap:4px}}.landing-page .f-key{{padding:7px;margin-bottom:6px;border-radius:8px}}.landing-page .f-label{{font-size:7px}}.landing-page .f-code{{font-size:8px;line-height:1.3;margin-top:2px}}.landing-page .f-statrow{{gap:5px}}.landing-page .f-stat{{padding:6px;border-radius:8px}}.landing-page .f-stat .f-label{{margin-bottom:2px}}.landing-page .f-stat strong{{font-size:10px}}.landing-page .f-devices{{gap:4px;margin-top:6px}}.landing-page .f-device{{padding:3px 5px;font-size:7px}}.f-footer{{height:32px;font-size:9px}}}}
