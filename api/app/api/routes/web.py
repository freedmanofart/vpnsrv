...
async def landing(db: AsyncSession = Depends(get_db)):
    ...
    body = f"""<div class=\"site-top\"><div class=\"f-wrap\"><nav class=\"f-nav\" aria-label=\"Основная навигация\"><a class=\"f-brand\" href=\"/\"><img class=\"f-mark\" src=\"/static/freedom-vpn-logo.png\" width=\"42\" height=\"42\" alt=\"\"><span>Freedom VPN</span></a><div class=\"f-links\"><a href=\"#advantages\">Возможности</a><a href=\"#plans\">Тарифы</a></div><div class=\"f-actions\"><a class=\"f-btn\" href=\"/cabinet\">Кабинет</a><button class=\"f-btn primary\" type=\"button\" data-plan=\"{plans[0].id if plans else ''}\">Подключить</button></div></nav></div><section class=\"f-hero\"><div><div class=\"f-kicker\"><i></i>Свободный интернет без лишнего</div><h1>Быстрый и приватный интернет</h1><p class=\"f-lead\">Freedom VPN защищает ваше соединение и открывает доступ к сайтам и сервисам. Один аккаунт — все устройства, без рекламы и слежки.</p><div class=\"f-hero-actions\"><button class=\"f-btn primary\" type=\"button\" data-plan=\"{plans[0].id if plans else ''}\">Выбрать подписку ↗</button><a class=\"f-btn\" href=\"#advantages\">Как это работает</a></div><div class=\"f-trust\"><span><b class=\"f-dot\"></b>Сервера в 12 странах</span><span><b class=\"f-dot\"></b>Поддержка 24/7</span><span><b class=\"f-dot\"></b>Без логов</span></div></div><div class=\"f-visual\"><div class=\"f-preview\" aria-label=\"Предпросмотр личного кабинета\"><div class=\"f-preview-inner\"><div class=\"f-preview-top\"><div class=\"f-preview-brand\"><img class=\"f-mark\" src=\"/static/freedom-vpn-logo.png\" width=\"32\" height=\"32\" alt=\"\">Freedom VPN</div><div class=\"f-status\"><b></b>Подключено</div></div><div class=\"f-key\"><div class=\"f-label\">Ключ доступа</div><div class=\"f-code\">freedom://vpn_7b91••••••••••••••••••••</div></div><div class=\"f-statrow\"><div class=\"f-stat\"><span class=\"f-label\">Локация</span><strong>Германия</strong></div><div class=\"f-stat\"><span class=\"f-label\">Задержка</span><strong>24 мс</strong></div></div><div class=\"f-devices\"><span class=\"f-device\">iOS</span><span class=\"f-device\">Android</span><span class=\"f-device\">Windows</span><span class=\"f-device\">Роутер</span></div></div></div></div></section></div>
