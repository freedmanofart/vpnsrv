...
.l-hero{{min-height:470px;padding:48px 40px 32px;display:grid;grid-template-columns:minmax(0,1fr) 480px;gap:56px;align-items:center;background:linear-gradient(135deg,#fff 15%,#f2f7ff 100%)}}
...
.l-platform-line{{margin:14px 0 0;color:#365995;font-size:14px;line-height:20px}}
.l-phone-stage{{min-width:0;display:flex;align-items:center;justify-content:center;position:relative}}
.l-phone-glow{{position:absolute;width:380px;height:180px;border-radius:50%;background:rgb(36 91 255 / .14);filter:blur(42px);bottom:18px}}
...
.l-benefits{{padding:0 40px;display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}}
...
.l-footer{{min-height:64px;padding:0 40px;display:flex;align-items:center;justify-content:space-between;gap:24px;color:var(--color-text-secondary);font-size:13px;line-height:18px}}
.l-footer strong{{color:var(--color-text)}}
.l-footer-links{{display:flex;align-items:center;justify-content:flex-end;gap:24px;flex-wrap:wrap}}
...
<footer class=\"l-footer\"><strong>Freedom VPN</strong><nav class=\"l-footer-links\" aria-label=\"Документы и контакты\"><a href=\"/static/privacy.html\">Конфиденциальность</a><a href=\"/static/terms.html\">Условия использования</a><a href=\"https://t.me/Freedom_VPN_Support\" target=\"_blank\" rel=\"noopener noreferrer\">Контакты</a></nav></footer>
</div>
