...
body{{font-family:ui-rounded,"SF Pro Rounded","Avenir Next",Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}}.landing-page{{min-height:100dvh;display:grid;grid-template-rows:auto 1fr}}.landing-page .f-hero{{min-height:calc(100dvh - 76px);padding-top:clamp(42px,7vh,75px);padding-bottom:clamp(42px,7vh,82px)}}.landing-page .f-brand,.landing-page .f-preview-brand{{font-size:20px;line-height:1.08;letter-spacing:-.035em;gap:7px}}.landing-page .f-brand .f-mark{{width:38px;height:38px;mix-blend-mode:multiply}}.landing-page .f-brand span,.landing-page .f-preview-brand span{{font-weight:720}}.landing-page .f-brand>i,.landing-page .f-preview-brand>i{{font-weight:430;letter-spacing:-.025em}}.landing-page .f-cabinet{{color:var(--blue);border-color:#d8e0ee;background:#fff;padding-left:21px;padding-right:21px}}.landing-page .f-cabinet:hover{{border-color:var(--blue);box-shadow:0 8px 22px #175cff18}}.landing-page .f-hero h1{{font-weight:680}}@media(max-width:850px){{.landing-page .f-hero{{min-height:calc(100dvh - 68px);display:flex;padding-top:clamp(38px,8vh,70px);padding-bottom:38px}}.landing-page .f-visual{{display:none}}}}@media(max-width:520px){{.landing-page .f-brand{{font-size:17px}}.landing-page .f-brand .f-mark{{width:32px;height:32px}}.landing-page .f-actions .f-cabinet{{display:inline-flex}}.landing-page .f-hero{{min-height:calc(100dvh - 64px)}}.landing-page .f-trust{{gap:11px 16px}}}}@media(max-width:390px){{.landing-page .f-brand{{font-size:15px}}.landing-page .f-brand .f-mark{{width:30px;height:30px}}}}
