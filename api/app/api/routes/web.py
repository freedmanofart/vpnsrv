...
.landing-page{{min-height:100dvh;display:grid;grid-template-rows:auto 1fr 6px}}.landing-page .f-hero{{min-height:calc(100dvh - 82px);border-radius:30px;padding:clamp(32px,5vh,54px) 38px;gap:32px}}.landing-page .f-hero h1{{font-size:clamp(36px,4.4vw,58px);margin-bottom:18px}}.landing-page .f-kicker{{margin-bottom:16px}}.landing-page .f-lead{{font-size:15px;line-height:1.55;margin-bottom:23px}}.landing-page .f-btn.primary{{padding:10px 18px}}.landing-page .f-trust{{margin-top:22px}}.landing-page .f-preview{{max-width:440px;justify-self:end;padding:11px;border-radius:23px}}.landing-page .f-preview-inner{{padding:20px}}.landing-page .f-preview-top{{margin-bottom:20px}}.landing-page .f-key{{padding:13px}}.landing-page .f-stat{{padding:12px}}.landing-page .f-cabinet{{color:var(--blue);border-color:#d8e0ee;background:#fff;padding-left:21px;padding-right:21px}}.landing-page .f-cabinet:hover{{border-color:var(--blue);box-shadow:0 8px 22px #175cff18}}.f-footer{{height:6px;background:var(--green)}}@media(max-width:850px){{.landing-page .f-hero{{min-height:calc(100dvh - 82px);display:flex;padding:32px 24px}}.landing-page .f-visual{{display:none}}.landing-page .f-hero>div:first-child{{width:min(560px,100%);margin:auto;text-align:center}}.landing-page .f-kicker,.landing-page .f-hero-actions,.landing-page .f-trust{{justify-content:center}}.landing-page .f-lead{{margin-left:auto;margin-right:auto}}}}@media(max-width:520px){{.landing-page .f-actions .f-cabinet{{display:inline-flex}}.landing-page .f-hero{{min-height:calc(100dvh - 70px);padding:26px 24px}}.landing-page .f-hero h1{{font-size:clamp(34px,10vw,43px)}}.landing-page .f-trust{{gap:10px 15px;margin-top:18px}}}}
